...
export const Buses = ({navigation}) => {
    return (
        <Layout style={{ flex: 1 }}>
            <Layout style={{marginHorizontal:20, marginTop:20,paddingVertical:20}}>
                <AutocompleteAccessoriesShowcase />
                <Layout style={{flexDirection:'row'}}>
                    <Button onPress={()=> navigation.push('Mapa')} style={{flex:1, marginHorizontal:2}} size="small" status="basic" accessoryLeft={renderIconPin}>Ver mapa</Button>
